...
%c) Valores deseados h(0.5, -0.4, 0.0)  
    q1d = [-1.5 -1.5  0.5  0.5 -1.5];   % Posición deseadas de la articular del eslabón 1  
    q2d = [ 1.5  1.5 -0.5 -0.5 1.5];   % Posición deseadas de la articular del eslabón 2
    
    hzd = [0 0.2 0.2 0 0.2];      % Posición deseadas del extremo operativo en el eje Z
...
%3)Ley de Control
   ...
   T_ref = K*tanh(2*qe) + D*tanh(2*qpe); 
